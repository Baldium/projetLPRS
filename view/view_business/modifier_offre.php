...
<body>
  <div class="container">
    ...
    <div class="form-section">
      <form action="../../controller/controllerBusiness/process_modifier_offre.php" method="post">
      <input type="hidden" name="id_offers_update" value="<?php echo htmlspecialchars($_GET['id']); ?>">
        ...
        <div class="form-actions">
          ...
          <button type="button" class="btn btn-cancel" onclick="window.location.href='mes_offres_business.php'">Annuler</button>
        </div>
      </form>
    </div>
  </div>
