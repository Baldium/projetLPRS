  ...
  <div class="container">
    ...
    <div class="profile-info">
      <div class="profile-info-item">
        ...
        <span class="profile-info-value"><?php SocietyRepository::my_profil_society('nom_society')?></span>
      </div>
      <div class="profile-info-item">
        <span class="profile-info-label">Adresse:</span>
        <span class="profile-info-value"><?php SocietyRepository::my_profil_society('adress_society')?></span>
      </div>
      <div class="profile-info-item">
        <span class="profile-info-label">Site Web:</span>
        <span class="profile-info-value"><a href="<?php SocietyRepository::my_profil_society('website')?>" target="_blank"><?php SocietyRepository::my_profil_society('website')?></a></span>
      </div>
      <div class="profile-info-item">
        <span class="profile-info-label">Email:</span>
        <span class="profile-info-value"><?php SocietyRepository::my_profil_society('mail')?></span>
      </div>
    </div>

    <!-- Boutons d'action -->
    <div class="form-actions">
      <button type="button" class="btn btn-update" onclick="window.location.href='../view/modification_profil_business.php'">Modifier le profil</button>
